            ...
            <div className="backdrop-blur-xl bg-transparent rounded-3xl p-8 md:p-12 mb-32">
              ...
              <div className="flex md:justify-left md:pl-4">
                <button
                  ...
                  className="h-16 px-8 border border-white/30 backdrop-blur-xl text-white rounded-lg font-semibold text-xl transition-all duration-300 ease-in-out hover:bg-white hover:text-black active:scale-95"
                >
                  Apply Now
                </button>
              </div>
        ...
        You are already registered.
              ...
              <form onSubmit={handleSubmit} className="w-full max-w-4xl space-y-6 backdrop-blur-md bg-black/60 md:bg-transparent p-6  rounded-2xl border border-white/20">
                ...
                <div className="flex w-full justify-center">
                  <button
                    type="submit"
                    className="mt-6 h-14 border border-white/30 rounded-xl backdrop-blur-lg text-white font-semibold text-lg transition-all duration-300 ease-in-out hover:bg-white hover:text-black active:scale-95 w-full md:w-48"
                    disabled={loading}>
